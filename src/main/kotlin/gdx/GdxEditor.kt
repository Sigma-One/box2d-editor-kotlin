...
class GdxEditor: ApplicationAdapter() {
    ...
    override fun create() {
        ...
        DataHolder.meshes.add(Mesh(Point(0.5f, 0.5f)))
    ...
    fun input() {
        ...
        if (Gdx.input.isButtonJustPressed(0)) {
            ...
            if (getPointAtPos(screenPos.x, screenPos.y) == null) {
                DataHolder.meshes[0].points.add(pointPos)
            }
        ...
        if (Gdx.input.isButtonJustPressed(1)) {
            ...
            if (getPointAtPos(screenPos.x, screenPos.y) != null) {
                DataHolder.meshes[0].points.remove(getPointAtPos(screenPos.x, screenPos.y))
            }
        }
    }
